    ...
    return (
        <>
            <div id="contact" className="min-h-screen my-auto p-12">
                <p className="text-2xl md:text-4xl font-medium md:mb-4 py-5 break-words text-wrap text-center">Get in touch</p>
                        ...
                        <div className="grid sm:grid-cols-2 items-center gap-10 p-8 mx-auto max-w-6xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                            <div className="p-9">
                                ...
                                <p className="text-sm text-gray-400 mt-3 break-words">
                                    ...
                                    Email us at craftwarelab@gmail.com to set up a free, no-obligation discovery call. Let&rsquo;s have a chat to see how we can support you
                                </p>
                                <div className="mt-12">
                                    ...
                                    <ul className="mt-3">
                                        <li className="flex items-center">
                                            ...
                                            <a target="blank" href="mailto:m.craftwarelab@gmail.com" className="text-[#007bff] text-sm ml-3">
